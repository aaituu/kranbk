  ...
  return (
    <div className="space-y-6 sm:space-y-8 max-w-2xl">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Новый продукт</h1>
          <p className="text-gray-600 mt-1 text-sm sm:text-base">Добавление продукта в каталог</p>
        </div>
      </div>
